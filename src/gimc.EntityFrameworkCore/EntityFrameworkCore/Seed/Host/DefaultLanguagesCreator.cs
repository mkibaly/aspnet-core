...
namespace gimc.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly gimcDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = gimcConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(gimcDbContext context)
        {
            _context = context;
        }
